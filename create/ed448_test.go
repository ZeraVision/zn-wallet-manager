...
func TestGenerateEd448_BLAKE3(t *testing.T) {
	testGenerateEd448(t, BLAKE3, "B_c_8TZAaoUWbGvkxaWdWBXJ3mVHXVXLDJgtbeexkBzj5ySjpru7yZvfuKwGGHt2gtFpQfQCaRnBPU43bV", "Hv3KUwrmR8C8XVSxuJFJrQqeDixeDnakUTkUUMZkFCUS")
}

func TestGenerateEd448_SHA3_256(t *testing.T) {
	testGenerateEd448(t, SHA3_256, "B_a_8TZAaoUWbGvkxaWdWBXJ3mVHXVXLDJgtbeexkBzj5ySjpru7yZvfuKwGGHt2gtFpQfQCaRnBPU43bV", "GmAMncQSf9xxCcyib1Xx7jVdXesD868s86XJiwTTspU1")
}

func TestGenerateEd448_SHA3_512(t *testing.T) {
	testGenerateEd448(t, SHA3_512, "B_b_8TZAaoUWbGvkxaWdWBXJ3mVHXVXLDJgtbeexkBzj5ySjpru7yZvfuKwGGHt2gtFpQfQCaRnBPU43bV", "4RsD3dH143UCfxscj8xPLGHJCaWeWZmEVUoF42VbkNss5v2UmojFFqbtZ9M5qwPH94euxq3bHodfM2qSiYnnodtU")
}

func testGenerateEd448(t *testing.T, hashAlgorithm HashType, expectedPublicKey, expectedAddress string) {
...
func TestGenerateEd448_All(t *testing.T) {
	t.Run("BLAKE3", TestGenerateEd448_BLAKE3)
	t.Run("SHA3_256", TestGenerateEd448_SHA3_256)
	t.Run("SHA3_512", TestGenerateEd448_SHA3_512)
}
